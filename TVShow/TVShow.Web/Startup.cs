...
namespace TVShows.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<TVShowsDbContext>(options => options.UseSqlServer(configurationSection.Value));
            services.AddScoped<ITVShowsDbContext, TVShowsDbContext>();
            services.AddScoped(provider =>
                    new Func<ITVShowsDbContext>(() => provider.GetService<ITVShowsDbContext>())
                );
